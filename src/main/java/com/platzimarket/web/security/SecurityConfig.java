...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    //aqui indicamos donde tiene q hacer la configuracion "authenticate" es lo q tenemos en el controller
    @Override
    ...
    //aqui con bean decimos que spring se encarge la gestion de autentificacion
    @Override
    @Bean
